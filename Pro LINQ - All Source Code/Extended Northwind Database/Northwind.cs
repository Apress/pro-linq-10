...
namespace nwind
{
    ...
    partial void DeleteTerritory(Territory instance);
		...
		public ISingleResult<CustOrderHistResult> CustOrderHist(string customerID)
		{
		...
		public int CustOrderTotal(string customerID, ref System.Nullable<decimal> totalSales)
		{
